      ...
      >
        ...
        <Modal.Body className="px-lg-5 px-3 ">
          ...
          <div className="row w-100 p-0 mb-4 mt-3">
            ...
            <div className={`d-flex gap-3 flex-wrap ${styles.filteredregion}`}>
              <RadioGroup
            ...
            >
              ...
              >
                <Image
                  ...
                  src={
                    selectedDescriptors?.includes("food") ? sculture : culture
                  }
                  width={40}
                  height={40}
                  alt=""
              ...
              >
                <Image
                  className={`${styles.foodIcons}`}
                  src={selectedDescriptors?.includes("Hiking") ? sfood : food}
                  width={40}
                  height={40}
                  alt=""
                />
              ...
              <div
                className={`justify-between d-flex text-decoration-none align-items-center  gap-lg-3 gap-1 mt-1 px-lg-3 px-0 py-2 ${
                  ...
                  selectedDescriptors?.includes("family") ? styles.selected : ""
                }`}
              ...
              >
                <Image
                  className={`${styles.foodIcons}`}
                  src={
                    selectedDescriptors?.includes("family") ? sfamily : family
                  }
                  width={40}
                  height={40}
                  alt=""
              ...
              <div
                className={`justify-between d-flex text-decoration-none align-items-center  gap-lg-2 gap-1 px-lg-1 px-0 py-2 mt-1 ${
                  ...
                  selectedDescriptors?.includes("fgroup") ? styles.selected : ""
                }`}
              ...
              >
                <Image
                  className={`${styles.foodIcons}`}
                  src={
                    selectedDescriptors?.includes("fgroup") ? sfgroup : fgroup
                  }
                  width={40}
                  height={40}
                  alt=""
              ...
              <div
                className={`justify-between d-flex text-decoration-none align-items-center  gap-lg-2 gap-1 px-lg-2 px-2 py-1 mt-1 ${
                  ...
                  selectedDescriptors?.includes("hanged") ? styles.selected : ""
                }`}
              ...
              >
                <Image
                  className={`${styles.foodIcons}`}
                  src={
                    selectedDescriptors?.includes("hanged") ? shanged : hanged
                  }
                  width={40}
                  height={40}
                  alt=""
              ...
              <div
                className={`justify-between d-flex text-decoration-none align-items-center  gap-lg-2 gap-1 px-lg-2 px-2 py-1 mt-1 ${
                  ...
                  selectedDescriptors?.includes("guitar") ? styles.selected : ""
                }`}
              ...
              >
                <Image
                  className={`${styles.foodIcons}`}
                  src={
                    selectedDescriptors?.includes("guitar") ? sguitar : guitar
                  }
                  width={40}
                  height={40}
                  alt=""
              ...
              <div
                className={`justify-between d-flex text-decoration-none align-items-center  gap-lg-2 gap-1 px-lg-2 px-2 py-1 mt-1 ${
                  ...
                  selectedDescriptors?.includes("nature") ? styles.selected : ""
                }`}
              ...
              >
                <Image
                  className={`${styles.foodIcons}`}
                  src={
                    selectedDescriptors?.includes("nature") ? snature : nature
                  }
                  width={40}
                  height={40}
                  alt=""
