  ...
  return (
    <div>
      <div className={`row justify-content-between align-items-center m-0 ${styles.footer_main}`}>
        <div className={` col-lg-2 col-6 ${styles.footer_col}`}>
          <Link className={styles.footer_link} href="/">
            About
          </Link>
        </div>
        <div className={` col-lg-2 col-6 text-ent ${styles.footer_col}`}>
          <Link className={styles.footer_link} href="/">
            Terms of Service
          </Link>
        </div>
        ...
        <div
          className={`col-lg-12  col-12 d-flex justify-content-between pt-3 ${styles.socialhero}`}
        >
